...
declare_id!("9FpG1pSDRFW2coUQfSwby36sn3bWQX5dayCiCA7erH2i");
...
pub mod nft_smart_contact {
    ...
    let seeds=&["mint".as_bytes(), id_bytes.as_ref(), &[ctx.bump.mint]];
        msg!("Run mint_to");

        mint_to (
            CpiContext::new_with_signer (
                ctx.aacounts.token_program.to_account_info(),
                MintTo {
                    authority: ctx.aacounts.authority.to_account_info(),
        ...
        msg!("Run create metadata accounts_v3");
